...
""" promting the user to add the amount they will like to deposit"""
def deposit():
    while True:
...
def get_number_of_lines():
    while True:
        lines = str(input("Enter the number of lines to bet on (1-" + str(MAX_LINES) + ")? "))
    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if MIN_BET <= amount <= MAX_BET:
                ...
                print("Bet must be less than 100")
